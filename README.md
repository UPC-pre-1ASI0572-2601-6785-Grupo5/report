...
|---------------------|--------------------|--------------|
| **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **Aguirre Castillo, Sergio Cesar**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Consolidé la integración de microservicios en entornos de producción, investigando y aplicando configuraciones finales de alta disponibilidad y seguridad en la nube para asegurar el cierre del ciclo de vida del proyecto (6.2.3).<br><br>**Almerco Rojas, Jocelyn Damaly**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Realicé una investigación profunda sobre estándares de calidad final para el despliegue, asegurando la consistencia entre la arquitectura C4 y la implementación real finalizada en el Sprint 3.<br><br>**Espejo Gamarra, Bryan Ronald**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Finalicé la optimización de las pipelines de despliegue continuo (CI/CD) para el Sprint 3, aplicando conocimientos avanzados en automatización de despliegues finales de producción.<br><br>**Iparraguirre Rueda, Cristian Luis**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Gestioné y lideré la ejecución final del Sprint Planning 3 (6.2.3.1), asegurando que todos los entregables técnicos y documentales cumplieran con los estándares de calidad definidos para la entrega TB2.<br><br>**Luque Minaya, Renzo Andrés**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Sinteticé y presenté las evidencias finales del sistema en el despliegue de producción (6.2.3.8), aplicando conocimientos en arquitectura de despliegue para garantizar la entrega exitosa del proyecto. |

| **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.** | **Aguirre Castillo, Sergio Cesar**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** En la entrega final, reconocí que el aprendizaje no termina con el despliegue, sino que el monitoreo post-producción y la auditoría técnica son los nuevos estándares de mejora continua.<br><br>**Almerco Rojas, Jocelyn Damaly**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Al finalizar el ciclo, reafirmé que la capacidad de adaptación y el aprendizaje autónomo son las competencias más valiosas para asegurar la sostenibilidad de cualquier solución de software.<br><br>**Espejo Gamarra, Bryan Ronald**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Reconocí que la mejora continua de la infraestructura y el despliegue es un compromiso a largo plazo para asegurar la calidad de servicio en entornos de producción reales.<br><br>**Iparraguirre Rueda, Cristian Luis**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Confirmé que la gestión ágil y la documentación de lecciones aprendidas son fundamentales para que el equipo pueda evolucionar y aplicar nuevas soluciones ante futuros retos profesionales.<br><br>**Luque Minaya, Renzo Andrés**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Entendí que la etapa final de entrega requiere un refinamiento constante y un análisis reflexivo, reafirmando que el desarrollo de software es un aprendizaje profesional de por vida. |

| **Conclusión general del aprendizaje continuo** | **Aguirre Castillo, Sergio Cesar**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** He interiorizado que el aprendizaje permanente es la única vía para mantenerse relevante en una industria tecnológica que evoluciona diariamente, siendo el cierre del proyecto una prueba de esta madurez profesional.<br><br>**Almerco Rojas, Jocelyn Damaly**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Reconozco que la culminación de este proyecto es solo el inicio, y que la disciplina del autoaprendizaje será el motor principal para afrontar futuros desafíos de ingeniería de nivel empresarial.<br><br>**Espejo Gamarra, Bryan Ronald**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** He comprendido que mantener la estabilidad de un sistema en producción exige un aprendizaje ininterrumpido, consolidando esta práctica como un hábito profesional innegociable.<br><br>**Iparraguirre Rueda, Cristian Luis**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Validé que la habilidad de liderar equipos y resolver problemas complejos en la fase final del proyecto es directamente proporcional a la profundidad del aprendizaje autónomo realizado.<br><br>**Luque Minaya, Renzo Andrés**<br><br>**AV1-AV2:** [Mantener contenido anterior]<br><br>**TB2:** Concluyo que el éxito del despliegue final de FuelTrack es la prueba clara de cómo la investigación constante y la formación continua transforman las dificultades técnicas en soluciones de alto valor. |
