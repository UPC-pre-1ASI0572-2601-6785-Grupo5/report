...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td rowspan="3" style="text-align: center; vertical-align: middle;"><b>TB2</b></td>
      <td>01/07/2026</td>
      <td>Iparraguirre Rueda, Cristian Luis</td>
      <td>Desarrollo de Sprint Planning 3, Sprint Backlog 3 y evidencias finales de implementación.</td>
    </tr>
    <tr>
      <td>03/07/2026</td>
      <td>Espejo Gamarra, Bryan Ronald</td>
      <td>Integración de evidencias de Software Deployment, Testing Suite y cierre de conclusiones.</td>
    </tr>
    <tr>
      <td>05/07/2026</td>
      <td>Aguirre Castillo, Sergio Cesar</td>
      <td>Revisión final del informe, consolidación de la versión de entrega TB2 y registro de Student Outcome.</td>
    </tr>
  </tbody>
</table>
...
| --- | --- | --- |
| **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **Aguirre Castillo, Sergio Cesar** <br> **AV1:** Actualicé y apliqué conocimientos en desarrollo de software utilizando lenguajes como Python, C# y JavaScript durante el desarrollo de FuelTrack. Participé en la implementación de funcionalidades del sistema y reforcé buenas prácticas de programación para mejorar la calidad del código. <br><br> **TB1:** Durante esta fase, identifiqué la necesidad de optimizar la lógica de negocio. Para ello, investigué de manera autónoma en la documentación oficial sobre la aplicación de principios SOLID y arquitecturas limpias utilizando Python y C#. Esta revisión independiente me permitió refactorizar el código existente e implementar algoritmos de procesamiento más robustos. <br><br> **AV2:** Actualicé y apliqué conocimientos avanzados en la ejecución y desarrollo para el Sprint 2 (6.2.2.4 y 6.2.2.6). Me enfoqué en elaborar la evidencia de desarrollo y ejecución para el Sprint Review, integrando de manera eficiente las nuevas funcionalidades requeridas en el Sprint Backlog. <br><br> **TB2:** Consolidé la integración de microservicios en entornos de producción, investigando y aplicando configuraciones finales de alta disponibilidad y seguridad en la nube para asegurar el cierre del ciclo de vida del proyecto (6.2.3). <br><br> **Almerco Rojas, Jocelyn Damaly** <br> **AV1:** Actualicé y apliqué conocimientos en diseño y modelado de software, elaborando diagramas y apoyando en la documentación técnica del sistema FuelTrack, asegurando una estructura clara y organizada. <br><br> **TB1:** Investigué estándares de UML avanzados y metodologías ágiles de documentación mediante tutoriales y guías oficiales. Esto me permitió rediseñar la arquitectura del sistema y aplicar el modelo C4 para hacer la estructura técnica del proyecto mucho más escalable y comprensible. <br><br> **AV2:** Investigué y apliqué metodologías de investigación de usuarios para el Diseño y Registro de las Entrevistas de Validación (6.3.1 y 6.3.2), además de estructurar la evidencia técnica de la documentación de servicios (6.2.2.7) necesaria para el Sprint Review. <br><br> **TB2:** Realicé una investigación profunda sobre estándares de calidad final para el despliegue, asegurando la consistencia entre la arquitectura C4 y la implementación real finalizada en el Sprint 3. <br><br> **Espejo Gamarra, Bryan Ronald** <br> **AV1:** Actualicé conocimientos en backend, bases de datos y DevOps, participando en la configuración y soporte técnico del sistema FuelTrack, asegurando su correcto funcionamiento. <br><br> **TB1:** Estudié de forma independiente la configuración de pipelines CI/CD y la optimización de consultas SQL complejas leyendo la documentación oficial de las herramientas DevOps. Esto permitió automatizar los pases a producción y optimizar el rendimiento de la base de datos de FuelTrack. <br><br> **AV2:** Amplié mis conocimientos en control de calidad técnica y DevOps, estructurando la evidencia de la suite de pruebas (6.2.2.5) y las evidencias de despliegue de software (6.2.2.8) para garantizar un Sprint 2 completamente funcional y estable. <br><br> **TB2:** Finalicé la optimización de las pipelines de despliegue continuo (CI/CD) para el Sprint 3, aplicando conocimientos avanzados en automatización de despliegues finales de producción. <br><br> **Iparraguirre Rueda, Cristian Luis** <br> **AV1:** Actualicé conocimientos en desarrollo de software utilizando lenguajes como Python, C++ y C#, apoyando en la implementación de funcionalidades del sistema y fortaleciendo mis habilidades técnicas. <br><br> **TB1:** Profundicé de manera autodidacta en patrones de diseño orientados a objetos y estructuras de datos eficientes aplicados en C# y Python. Utilicé plataformas de aprendizaje técnico para implementar estas mejoras en los módulos críticos del sistema, optimizando el consumo de recursos. <br><br> **AV2:** Actualicé conocimientos en metodologías ágiles para gestionar y liderar el Sprint Planning 2 (6.2.2.1), coordinar con el Aspect Leader (6.2.2.2) y estructurar el Sprint Backlog 2 (6.2.2.3), asegurando el cumplimiento de las tareas técnicas. <br><br> **TB2:** Gestioné y lideré la ejecución final del Sprint Planning 3 (6.2.3.1), asegurando que todos los entregables técnicos y documentales cumplieran con los estándares de calidad definidos para la entrega TB2. <br><br> **Luque Minaya, Renzo Andrés** <br> **AV1:** Actualicé conocimientos en desarrollo frontend, despliegue en la nube y seguridad, participando en la construcción de interfaces y en la configuración del sistema FuelTrack. <br><br> **TB1:** Aprendió de manera autodidacta sobre el manejo de estados complejos en el frontend y protocolos de seguridad de autenticación (como JWT), consultando la documentación oficial del framework. Esto me permitió mejorar la seguridad y la reactividad de la interfaz de usuario. <br><br> **AV2:** Apliqué conocimientos en edición multimedia, experiencia de usuario y redacción para la producción del Video About-the-Product (6.4), las evaluaciones según heurísticas de usabilidad (6.3.3) y la consolidación del Avance de Conclusiones, Bibliografía y Anexos. <br><br> **TB2:** Sinteticé y presenté las evidencias finales del sistema en el despliegue de producción (6.2.3.8), aplicando conocimientos en arquitectura de despliegue para garantizar la entrega exitosa del proyecto. | **Aguirre Castillo, Sergio Cesar** <br> **AV1:** La actualización de conocimientos permitió mejorar la calidad del desarrollo y optimizar la implementación de funcionalidades del sistema. <br><br> **TB1:** Esta experiencia me demostró que el dominio sintáctico de un lenguaje debe complementarse con la investigación de estándares de la industria, confirmando que la lectura de documentación técnica es indispensable para la escalabilidad del software. <br><br> **AV2:** Consolidé la capacidad de documentar la ejecución del software en tiempo real, demostrando que mantener evidencias de desarrollo claras durante el Sprint Review mejora sustancialmente la calidad técnica del entregable final. <br><br> **TB2:** La etapa de despliegue final consolidó mi capacidad de manejar entornos de producción reales, confirmando que la actualización técnica es vital incluso en la fase de cierre. <br><br> **Almerco Rojas, Jocelyn Damaly** <br> **AV1:** La actualización en diseño y documentación permitió estructurar de manera clara el sistema, facilitando su desarrollo. <br><br> **TB1:** Comprendí que la estandarización del diseño y el uso de modelos arquitectónicos modernos mediante investigación propia previene errores críticos en las etapas avanzadas del desarrollo. <br><br> **AV2:** Validé que la aplicación de métodos de entrevista y el contacto directo con los usuarios son fundamentales para refinar la documentación de servicios y adaptar la arquitectura a necesidades reales. <br><br> **TB2:** Validé que la estandarización técnica lograda mediante la investigación continua es el factor clave para el éxito en el despliegue final y la satisfacción de los requerimientos de la TB2. <br><br> **Espejo Gamarra, Bryan Ronald** <br> **AV1:** La actualización en backend y bases de datos permitió mejorar el rendimiento y la estabilidad del sistema. <br><br> **TB1:** El autoaprendizaje en automatización DevOps redujo drásticamente los tiempos de despliegue y minimizó errores humanos, demostrando el valor de la actualización constante en la infraestructura del proyecto. <br><br> **AV2:** Confirmé que la integración de suites de prueba sólidas y evidencias de despliegue sistemáticas son cruciales para garantizar la estabilidad del software en el entorno de producción antes de cada Sprint Review. <br><br> **TB2:** Confirmé que la automatización y la investigación constante de herramientas DevOps permiten una entrega resiliente y profesional del sistema en su etapa final. <br><br> **Iparraguirre Rueda, Cristian Luis** <br> **AV1:** La actualización de conocimientos técnicos permitió fortalecer las competencias en programación y contribuir al desarrollo del sistema. <br><br> **TB1:** La aplicación de patrones de diseño aprendidos por cuenta propia mejoró significativamente la mantenibilidad del código, evidenciando que ir más allá de la sintaxis básica es esencial en la ingeniería de software. <br><br> **AV2:** Comprendí que la correcta planificación ágil, un Sprint Backlog bien definido y la asignación eficiente de roles técnicos optimizan la resolución de problemas durante todo el ciclo del Sprint 2. <br><br> **TB2:** Entendí que liderar la etapa final requiere una actualización técnica integral que garantice la coherencia absoluta entre el plan inicial y el producto desplegado. <br><br> **Luque Minaya, Renzo Andrés** <br> **AV1:** La actualización en frontend y despliegue permitió mejorar la experiencia de usuario y la disponibilidad del sistema. <br><br> **TB1:** Validé que la investigación independiente en protocolos de seguridad y experiencia de usuario (UX/UI) es fundamental para prevenir vulnerabilidades y entregar un producto web de calidad profesional. <br><br> **AV2:** Aprendí que comunicar visualmente el valor del producto (mediante el video) y analizar heurísticamente la interfaz potencia significativamente la aceptación del usuario final y cierra adecuadamente el proyecto. <br><br> **TB2:** Concluí que la entrega final es el resultado de un proceso de aprendizaje ininterrumpido, donde la capacidad de sintetizar y presentar el valor del producto es tan importante como la implementación misma. |
| **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.** | **Aguirre Castillo, Sergio Cesar** <br> **AV1:** Reconocí la importancia del aprendizaje continuo al investigar nuevas tecnologías y buenas prácticas de desarrollo para mejorar mi desempeño en FuelTrack. <br><br> **TB1:** Al enfrentar desafíos técnicos no contemplados inicialmente, establecí una rutina de revisión de foros especializados y artículos sobre nuevas versiones de C# y Python, integrando soluciones modernas al producto. <br><br> **AV2:** Al recopilar la evidencia de desarrollo y ejecución del Sprint 2, reconocí la necesidad de investigar nuevas formas de monitorear el rendimiento del código para poder sustentar eficientemente los resultados en el Sprint Review. <br><br> **TB2:** En la entrega final, reconocí que el aprendizaje no termina con el despliegue, sino que el monitoreo post-producción y la auditoría técnica son los nuevos estándares de mejora continua. <br><br> **Almerco Rojas, Jocelyn Damaly** <br> **AV1:** Reconocí la necesidad del aprendizaje continuo al investigar nuevas herramientas de modelado y documentación para mejorar la calidad del sistema. <br><br> **TB1:** Evalué herramientas modernas de modelado comparando documentación técnica de diferentes proveedores para adoptar la opción que mejor se ajustara a los requerimientos cambiantes de FuelTrack. <br><br> **AV2:** Durante el diseño y registro de las entrevistas de validación, identifiqué la necesidad de aprender de forma continua sobre marcos de evaluación UX para saber cómo recolectar y aplicar el feedback de los usuarios reales. <br><br> **TB2:** Al finalizar el ciclo, reafirmé que la capacidad de adaptación y el aprendizaje autónomo son las competencias más valiosas para asegurar la sostenibilidad de cualquier solución de software. <br><br> **Espejo Gamarra, Bryan Ronald** <br> **AV1:** Reconocí la importancia del aprendizaje continuo al investigar nuevas tecnologías de backend y DevOps para optimizar el sistema. <br><br> **TB1:** Ante los cuellos de botella detectados en la base de datos, investigué técnicas de indexación avanzada y normalización en foros de administración de servidores, aplicando estos conceptos al sistema. <br><br> **AV2:** Reconocí la importancia de investigar continuamente sobre herramientas modernas de automatización de pruebas al preparar la Testing Suite y las evidencias formales de Software Deployment. <br><br> **TB2:** Reconocí que la mejora continua de la infraestructura y el despliegue es un compromiso a largo plazo para asegurar la calidad de servicio en entornos de producción reales. <br><br> **Iparraguirre Rueda, Cristian Luis** <br> **AV1:** Reconocí la necesidad del aprendizaje continuo al reforzar conocimientos en programación y nuevas herramientas de desarrollo. <br><br> **TB1:** Identifiqué limitaciones en los algoritmos base del proyecto y consulté repositorios open-source en GitHub para estudiar e integrar soluciones algorítmicas más eficientes creadas por la comunidad. <br><br> **AV2:** Identificando retos en la coordinación del equipo, investigué de forma autodidacta enfoques avanzados de Scrum y recabé "Team Collaboration Insights" (6.2.2.9) para mejorar las dinámicas de trabajo grupal. <br><br> **TB2:** Confirmé que la gestión ágil y la documentación de lecciones aprendidas son fundamentales para que el equipo pueda evolucionar y aplicar nuevas soluciones ante futuros retos profesionales. <br><br> **Luque Minaya, Renzo Andrés** <br> **AV1:** Reconocí la importancia del aprendizaje continuo al investigar nuevas tecnologías de frontend, cloud y seguridad para mejorar el sistema FuelTrack. <br><br> **TB1:** Monitoreé blogs de ciberseguridad y actualizaciones de los servicios Cloud utilizados en el proyecto para mitigar proactivamente cualquier riesgo en el despliegue del frontend. <br><br> **AV2:** Al consolidar el Video About-the-Product y las conclusiones finales, me vi en la necesidad de investigar técnicas modernas de storytelling técnico para presentar el producto de manera persuasiva ante stakeholders. <br><br> **TB2:** Entendí que la etapa final de entrega requiere un refinamiento constante y un análisis reflexivo, reafirmando que el desarrollo de software es un aprendizaje profesional de por vida. | **Aguirre Castillo, Sergio Cesar** <br> **AV1:** El aprendizaje continuo permite mantenerse actualizado y desarrollar soluciones más eficientes y escalables. <br><br> **TB1:** He interiorizado que el aprendizaje autónomo no es solo para superar obstáculos puntuales, sino un hábito profesional permanente que me brinda autonomía para enfrentar exigencias tecnológicas complejas. <br><br> **AV2:** Interioricé que documentar y evidenciar la ejecución técnica del software es un proceso continuo que exige mantenerse al día con los estándares modernos de auditoría y revisión técnica en entornos ágiles. <br><br> **TB2:** He interiorizado que el aprendizaje permanente es la única vía para mantenerse relevante en una industria tecnológica que evoluciona diariamente, siendo el cierre del proyecto una prueba de esta madurez profesional. <br><br> **Almerco Rojas, Jocelyn Damaly** <br> **AV1:** El aprendizaje permanente permite mejorar la calidad del diseño y la documentación del software. <br><br> **TB1:** Reconozco que evolucionar constantemente las técnicas de modelado es vital para poder comunicar arquitecturas complejas a los equipos de desarrollo a medida que el software escala en la vida real. <br><br> **AV2:** Reconozco que las necesidades y expectativas de los usuarios evolucionan constantemente, por lo que investigar nuevas metodologías de validación y usabilidad es una responsabilidad profesional ineludible. <br><br> **TB2:** Reconozco que la culminación de este proyecto es solo el inicio, y que la disciplina del autoaprendizaje será el motor principal para afrontar futuros desafíos de ingeniería de nivel empresarial. <br><br> **Espejo Gamarra, Bryan Ronald** <br> **AV1:** El aprendizaje continuo permite optimizar el rendimiento del sistema y adaptarse a nuevas tecnologías. <br><br> **TB1:** Interioricé que la infraestructura de un proyecto debe evolucionar a la par del sistema, haciendo de la investigación técnica una tarea continua y obligatoria en mi perfil como desarrollador backend. <br><br> **AV2:** Entendí que el testing automatizado y el despliegue continuo cambian constantemente, requiriendo un aprendizaje autodidacta ininterrumpido para mantener los servidores y la infraestructura del sistema resilientes. <br><br> **TB2:** He comprendido que mantener la estabilidad de un sistema en producción exige un aprendizaje ininterrumpido, consolidando esta práctica como un hábito profesional innegociable. <br><br> **Iparraguirre Rueda, Cristian Luis** <br> **AV1:** El aprendizaje permanente fortalece las habilidades técnicas necesarias para el desarrollo de software. <br><br> **TB1:** Comprendí que el análisis crítico de código de terceros y la lectura constante de repositorios es una práctica fundamental para no reinventar la rueda y asegurar soluciones óptimas en la industria. <br><br> **AV2:** Validé que el dominio de marcos de trabajo ágiles y las habilidades blandas requieren un refinamiento constante y análisis reflexivo para poder liderar equipos de alto rendimiento en la industria del software. <br><br> **TB2:** Validé que la habilidad de liderar equipos y resolver problemas complejos en la fase final del proyecto es directamente proporcional a la profundidad y calidad del aprendizaje autónomo realizado. <br><br> **Luque Minaya, Renzo Andrés** <br> **AV1:** El aprendizaje continuo permite mejorar la experiencia de usuario y la seguridad del sistema. <br><br> **TB1:** Entendí que en el ecosistema web y nube las actualizaciones son constantes, por lo que depender de una sola fuente de conocimiento es insuficiente para garantizar la seguridad y operatividad a largo plazo. <br><br> **AV2:** Comprendí que la etapa final de entrega de un software requiere de capacidades de presentación, evaluación heurística y síntesis documental que solo se logran afinar con la práctica y formación continua. <br><br> **TB2:** Concluyo que el éxito del despliegue final de FuelTrack es la prueba clara de cómo la investigación constante y la formación continua transforman las dificultades técnicas en soluciones de alto valor. |
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:center">Location</td>
      <td style="text-align:center">Virtual (Google Meet)</td>
    </tr>
    <tr>
      <td style="text-align:center">Prepared By</td>
      <td style="text-align:center">Sergio Aguirre Castillo</td>
    </tr>
    <tr>
      <td style="text-align:center">Attendees</td>
      <td style="text-align:center">Sergio Aguirre, Almerco Rojas, Espejo Gamarra, Iparraguirre Rueda, Luque Minaya</td>
    </tr>
    <tr>
      <td style="text-align:center">Sprint n – 1 Review Summary</td>
      <td style="text-align:center">Se validó con éxito el MVP del Sprint 2 y se completaron las entrevistas de validación.</td>
    </tr>
    <tr>
      <td style="text-align:center">Sprint n – 1 Retrospective Summary</td>
      <td style="text-align:center">Se optimizó la comunicación técnica entre el backend y los nodos edge para reducir latencia.</td>
    </tr>
    <tr>
      <td colspan="2"><strong>Sprint Goal & Metrics</strong></td>
    </tr>
    <tr>
      <td style="text-align:center">Sprint 3 Goal</td>
      <td style="text-align:center">Alcanzar la estabilidad funcional para el despliegue de producción, optimizar la suite de pruebas automatizadas y consolidar la documentación técnica del proyecto.</td>
    </tr>
    <tr>
...
<table>
  <thead>
    <tr>
      <th><strong>Team Member</strong></th>
      <th><strong>Order & Payment Leader</strong></th>
      <th><strong>IoT & Telemetry Leader</strong></th>
      <th><strong>Deployment & Documentation</strong></th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
> Nota: Inserta aquí el screenshot del Board de Trello/YouTrack y el URL público.
...
<table>
  ...
  <tbody>
    <tr>
      <td>TS44</td>
      <td>Seguridad de Vouchers (Hashing)</td>
      <td>8</td>
      <td>S. Aguirre</td>
      <td>Done</td>
    </tr>
    <tr>
      <td>TS47</td>
      <td>Implementación de pagos B2B</td>
      <td>12</td>
      <td>R. Luque</td>
      <td>Done</td>
    </tr>
    <tr>
      <td>US48</td>
      <td>Conformidad de entrega final</td>
      <td>10</td>
      <td>J. Almerco</td>
      <td>Done</td>
    </tr>
...
<table>
  ...
  <tbody>
    <tr>
      <td>fueltrack-backend</td>
      <td>main</td>
      <td>9d2a1b3</td>
      <td>fix: security patch on voucher hashing</td>
      <td>15/06/2026</td>
    </tr>
    <tr>
      <td>fueltrack-embedded</td>
      <td>main</td>
      <td>7b8c9d0</td>
      <td>perf: optimize sensor polling rate</td>
      <td>16/06/2026</td>
    </tr>
  </tbody>
</table>
...
Los archivos `.feature` de BDD se encuentran documentados en los repositorios correspondientes.
