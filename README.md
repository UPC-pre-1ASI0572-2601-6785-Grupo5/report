...
| --- | --- | --- |
| **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **Aguirre Castillo, Sergio Cesar** <br> **TB1:** Actualicé y apliqué conocimientos en desarrollo de software utilizando lenguajes como Python, C# y JavaScript durante el desarrollo de FuelTrack. Participé en la implementación de funcionalidades del sistema y reforcé buenas prácticas de programación para mejorar la calidad del código. <br><br> **TP:** Durante esta fase, identifiqué la necesidad de optimizar la lógica de negocio. Para ello, investigué de manera autónoma en la documentación oficial sobre la aplicación de principios SOLID y arquitecturas limpias utilizando Python y C#. Esta revisión independiente me permitió refactorizar el código existente e implementar algoritmos de procesamiento más robustos. <br><br> **Almerco Rojas, Jocelyn Damaly** <br> **TB1:** Actualicé y apliqué conocimientos en diseño y modelado de software, elaborando diagramas y apoyando en la documentación técnica del sistema FuelTrack, asegurando una estructura clara y organizada. <br><br> **TP:** Investigué estándares de UML avanzados y metodologías ágiles de documentación mediante tutoriales y guías oficiales. Esto me permitió rediseñar la arquitectura del sistema y aplicar el modelo C4 para hacer la estructura técnica del proyecto mucho más escalable y comprensible. <br><br> **Espejo Gamarra, Bryan Ronald** <br> **TB1:** Actualicé conocimientos en backend, bases de datos y DevOps, participando en la configuración y soporte técnico del sistema FuelTrack, asegurando su correcto funcionamiento. <br><br> **TP:** Estudié de forma independiente la configuración de pipelines CI/CD y la optimización de consultas SQL complejas leyendo la documentación oficial de las herramientas DevOps. Esto permitió automatizar los pases a producción y optimizar el rendimiento de la base de datos de FuelTrack. <br><br> **Iparraguirre Rueda, Cristian Luis** <br> **TB1:** Actualicé conocimientos en desarrollo de software utilizando lenguajes como Python, C++ y C#, apoyando en la implementación de funcionalidades del sistema y fortaleciendo mis habilidades técnicas. <br><br> **TP:** Profundicé de manera autodidacta en patrones de diseño orientados a objetos y estructuras de datos eficientes aplicados en C# y Python. Utilicé plataformas de aprendizaje técnico para implementar estas mejoras en los módulos críticos del sistema, optimizando el consumo de recursos. <br><br> **Luque Minaya, Renzo Andrés** <br> **TB1:** Actualicé conocimientos en desarrollo frontend, despliegue en la nube y seguridad, participando en la construcción de interfaces y en la configuración del sistema FuelTrack. <br><br> **TP:** Aprendió de manera autodidacta sobre el manejo de estados complejos en el frontend y protocolos de seguridad de autenticación (como JWT), consultando la documentación oficial del framework. Esto me permitió mejorar la seguridad y la reactividad de la interfaz de usuario. | **Aguirre Castillo, Sergio Cesar** <br> **TB1:** La actualización de conocimientos permitió mejorar la calidad del desarrollo y optimizar la implementación de funcionalidades del sistema. <br><br> **TP:** Esta experiencia me demostró que el dominio sintáctico de un lenguaje debe complementarse con la investigación de estándares de la industria, confirmando que la lectura de documentación técnica es indispensable para la escalabilidad del software. <br><br> **Almerco Rojas, Jocelyn Damaly** <br> **TB1:** La actualización en diseño y documentación permitió estructurar de manera clara el sistema, facilitando su desarrollo. <br><br> **TP:** Comprendí que la estandarización del diseño y el uso de modelos arquitectónicos modernos mediante investigación propia previene errores críticos en las etapas avanzadas del desarrollo. <br><br> **Espejo Gamarra, Bryan Ronald** <br> **TB1:** La actualización en backend y bases de datos permitió mejorar el rendimiento y la estabilidad del sistema. <br><br> **TP:** El autoaprendizaje en automatización DevOps redujo drásticamente los tiempos de despliegue y minimizó errores humanos, demostrando el valor de la actualización constante en la infraestructura del proyecto. <br><br> **Iparraguirre Rueda, Cristian Luis** <br> **TB1:** La actualización de conocimientos técnicos permitió fortalecer las competencias en programación y contribuir al desarrollo del sistema. <br><br> **TP:** La aplicación de patrones de diseño aprendidos por cuenta propia mejoró significativamente la mantenibilidad del código, evidenciando que ir más allá de la sintaxis básica es esencial en la ingeniería de software. <br><br> **Luque Minaya, Renzo Andrés** <br> **TB1:** La actualización en frontend y despliegue permitió mejorar la experiencia de usuario y la disponibilidad del sistema. <br><br> **TP:** Validé que la investigación independiente en protocolos de seguridad y experiencia de usuario (UX/UI) es fundamental para prevenir vulnerabilidades y entregar un producto web de calidad profesional. |
| **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.** | **Aguirre Castillo, Sergio Cesar** <br> **TB1:** Reconocí la importancia del aprendizaje continuo al investigar nuevas tecnologías y buenas prácticas de desarrollo para mejorar mi desempeño en FuelTrack. <br><br> **TP:** Al enfrentar desafíos técnicos no contemplados inicialmente, establecí una rutina de revisión de foros especializados y artículos sobre nuevas versiones de C# y Python, integrando soluciones modernas al producto. <br><br> **Almerco Rojas, Jocelyn Damaly** <br> **TB1:** Reconocí la necesidad del aprendizaje continuo al investigar nuevas herramientas de modelado y documentación para mejorar la calidad del sistema. <br><br> **TP:** Evalué herramientas modernas de modelado comparando documentación técnica de diferentes proveedores para adoptar la opción que mejor se ajustara a los requerimientos cambiantes de FuelTrack. <br><br> **Espejo Gamarra, Bryan Ronald** <br> **TB1:** Reconocí la importancia del aprendizaje continuo al investigar nuevas tecnologías de backend y DevOps para optimizar el sistema. <br><br> **TP:** Ante los cuellos de botella detectados en la base de datos, investigué técnicas de indexación avanzada y normalización en foros de administración de servidores, aplicando estos conceptos al sistema. <br><br> **Iparraguirre Rueda, Cristian Luis** <br> **TB1:** Reconocí la necesidad del aprendizaje continuo al reforzar conocimientos en programación y nuevas herramientas de desarrollo. <br><br> **TP:** Identifiqué limitaciones en los algoritmos base del proyecto y consulté repositorios open-source en GitHub para estudiar e integrar soluciones algorítmicas más eficientes creadas por la comunidad. <br><br> **Luque Minaya, Renzo Andrés** <br> **TB1:** Reconocí la importancia del aprendizaje continuo al investigar nuevas tecnologías de frontend, cloud y seguridad para mejorar el sistema FuelTrack. <br><br> **TP:** Monitoreé blogs de ciberseguridad y actualizaciones de los servicios Cloud utilizados en el proyecto para mitigar proactivamente cualquier riesgo en el despliegue del frontend. | **Aguirre Castillo, Sergio Cesar** <br> **TB1:** El aprendizaje continuo permite mantenerse actualizado y desarrollar soluciones más eficientes y escalables. <br><br> **TP:** He interiorizado que el aprendizaje autónomo no es solo para superar obstáculos puntuales, sino un hábito profesional permanente que me brinda autonomía para enfrentar exigencias tecnológicas complejas. <br><br> **Almerco Rojas, Jocelyn Damaly** <br> **TB1:** El aprendizaje permanente permite mejorar la calidad del diseño y la documentación del software. <br><br> **TP:** Reconozco que evolucionar constantemente las técnicas de modelado es vital para poder comunicar arquitecturas complejas a los equipos de desarrollo a medida que el software escala en la vida real. <br><br> **Espejo Gamarra, Bryan Ronald** <br> **TB1:** El aprendizaje continuo permite optimizar el rendimiento del sistema y adaptarse a nuevas tecnologías. <br><br> **TP:** Interioricé que la infraestructura de un proyecto debe evolucionar a la par del sistema, haciendo de la investigación técnica una tarea continua y obligatoria en mi perfil como desarrollador backend. <br><br> **Iparraguirre Rueda, Cristian Luis** <br> **TB1:** El aprendizaje permanente fortalece las habilidades técnicas necesarias para el desarrollo de software. <br><br> **TP:** Comprendí que el análisis crítico de código de terceros y la lectura constante de repositorios es una práctica fundamental para no reinventar la rueda y asegurar soluciones óptimas en la industria. <br><br> **Luque Minaya, Renzo Andrés** <br> **TB1:** El aprendizaje continuo permite mejorar la experiencia de usuario y la seguridad del sistema. <br><br> **TP:** Entendí que en el ecosistema web y nube las actualizaciones son constantes, por lo que depender de una sola fuente de conocimiento es insuficiente para garantizar la seguridad y operatividad a largo plazo. |                                                                                                                 |
